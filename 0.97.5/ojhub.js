		...
		`<div style="background-color:var(--color-profile)">`+
			`<div class=contentAdaptiveFlexSmall style=position:relative;align-items:center;justify-content:center;overflow:hidden>`+
				...
				`<div style=position:relative;width:35vw;height:370px;z-index:1>`+
					...
					`<img src="${helperUrl}imgs/gem.webp"   height=322px style="filter:drop-shadow(2px 2px 8px #000);position:absolute;right:420px;top:100px">`+
					`<img src="${helperUrl}imgs/gasi.webp"  height=348px style="filter:drop-shadow(2px 2px 8px #000);position:absolute;right:270px;top:50px;transform:rotate(-3deg)">`+
					`<img src="${helperUrl}imgs/share.webp" height=424px style="filter:drop-shadow(2px 2px 8px #000);position:absolute;right:-20px;top:-11px;transform:rotate(0deg)">`+
				`</div>`+
			`</div>`+
